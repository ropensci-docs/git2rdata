...
- [`recent_commit()`](https://docs.ropensci.org/git2rdata/reference/recent_commit.md)
...
- [`write_vc()`](https://docs.ropensci.org/git2rdata/reference/write_vc.md)
  and [`meta()`](https://docs.ropensci.org/git2rdata/reference/meta.md)
...
- Add
  ...
  [`vignette("metadata")`](https://docs.ropensci.org/git2rdata/articles/metadata.md)
  for more details.
...
- [`write_vc()`](https://docs.ropensci.org/git2rdata/reference/write_vc.md)
  ...
  [`vignette("split_by")`](https://docs.ropensci.org/git2rdata/articles/split_by.md)
  for more details.
- [`rename_variable()`](https://docs.ropensci.org/git2rdata/reference/rename_variable.md)
...
- [`read_vc()`](https://docs.ropensci.org/git2rdata/reference/read_vc.md),
  [`is_git2rdata()`](https://docs.ropensci.org/git2rdata/reference/is_git2rdata.md)
  and
  [`is_git2rmeta()`](https://docs.ropensci.org/git2rdata/reference/is_git2rmeta.md)
...
- Calculation of data hash has changed
  ...
  use
  [`upgrade_data()`](https://docs.ropensci.org/git2rdata/reference/upgrade_data.md)
...
- Update timings in
  [`vignette("efficiency", package = "git2rdata")`](https://docs.ropensci.org/git2rdata/articles/efficiency.md)
- Minor tweaks in
  [`vignette("plain_text", package = "git2rdata")`](https://docs.ropensci.org/git2rdata/articles/plain_text.md)
...
- [`meta()`](https://docs.ropensci.org/git2rdata/reference/meta.md)
...
- [`write.table()`](https://rdrr.io/r/utils/write.table.html) stores the
  raw data instead of `readr::write_tsv()`
