...
```
    ...
    ##  - attr(*, "source")= Named chr [1:2] "/tmp/RtmpMKuzO4/git2rdata-metadataa2830de9b97/iris.tsv" "/tmp/RtmpMKuzO4/git2rdata-metadataa2830de9b97/iris.yml"
...
```
    ...
    ## Title: NA
    ## Description: NA
    ## Path: /tmp/RtmpMKuzO4/git2rdata-metadataa2830de9b97/iris.tsv (9282fad022c924c16a76bd8b3c174e71fc4515fe), /tmp/RtmpMKuzO4/git2rdata-metadataa2830de9b97/iris.yml (f5eda4fcbe143eefc267a51a511110c604848272)
...
```
    ...
    ## Path: /tmp/RtmpMKuzO4/git2rdata-metadataa2830de9b97/iris.tsv (9282fad022c924c16a76bd8b3c174e71fc4515fe), /tmp/RtmpMKuzO4/git2rdata-metadataa2830de9b97/iris.yml (a8e8987f123e0aea13157081b03b47f2b039b1bf)
    ## Sorting order: Sepal.Length
    ## Optimized storage: TRUE
    ## Variables:
    ##   - Sepal.Length: The length of the sepal in cm
