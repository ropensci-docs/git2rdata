...
#> path[1]="/tmp/RtmpDWtg4i/git2rdata-workflow-remoteb383243c091": No such file or
#> directory
dir.create(remote)
...
#> path[1]="/tmp/RtmpDWtg4i/git2rdata-workflowb387c5d23d0": No such file or
#> directory
dir.create(path)
...
#> [cc6b2ad] 2026-08-30: Initial commit
...
We can use
[`status()`](https://docs.ropensci.org/git2rdata/reference/status.md) to
check that
[`write_vc()`](https://docs.ropensci.org/git2rdata/reference/write_vc.md)
...
**dataset:** beaver.tsv  
**commit:** 0422f2fc23b1d7f45d6b649d226bd3156cb8d99a  
**repository:** /tmp/RtmpDWtg4i/git2rdata-workflow-remoteb383243c091
{.table}
...
**dataset:** beaver.tsv  
**commit:** ed194c48ba56c7aa708ae80863015d784c2a9da0  
**repository:** /tmp/RtmpDWtg4i/git2rdata-workflow-remoteb383243c091
{.table}
...
**commit:** 0c070728f62f33831c49f2082e18cd9706cf53a7  
**repository:** /tmp/RtmpDWtg4i/git2rdata-workflow-remoteb383243c091
{.table}
